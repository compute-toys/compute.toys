...
// Removed Next.js a import - using standard anchor tags
...
const ExplainerBody = () => {
    ...
    return (
        ...
        >
            This is a playground for WebGPU compute shaders. Everything here is written in WGSL,
            ...
            <br />
            <h1>Inputs</h1>
            Available inputs are: keyboard input, mouse input, selectable input textures, custom values
            ...
            <h1>Preprocessor</h1>
            There is also an experimental WGSL preprocessor. It currently allows the use of
            ...
            */}
            ...
            <div style={{ fontWeight: 'bold', fontSize: '0.8rem' }}>
                <a href={'https://compute.toys/view/46'} target="_blank" rel="noopener noreferrer">
                    Preprocessor #include
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/76'} target="_blank" rel="noopener noreferrer">
                    Storage usage
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/1334'} target="_blank" rel="noopener noreferrer">
                    Texture usage
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/77'} target="_blank" rel="noopener noreferrer">
                    Texture pass
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/1586'} target="_blank" rel="noopener noreferrer">
                    Custom uniforms
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/47'} target="_blank" rel="noopener noreferrer">
                    Preprocessor #workgroup_count
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/528'} target="_blank" rel="noopener noreferrer">
                    Preprocessor #dispatch_once
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/48'} target="_blank" rel="noopener noreferrer">
                    Preprocessor #dispatch_count
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/25'} target="_blank" rel="noopener noreferrer">
                    Workgroup shared memory
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/210'} target="_blank" rel="noopener noreferrer">
                    Threads execution order
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/1199'} target="_blank" rel="noopener noreferrer">
                    Enable WGSL extension
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/59'} target="_blank" rel="noopener noreferrer">
                    Terminal text overlay
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/459'} target="_blank" rel="noopener noreferrer">
                    Simple raymarcher
                </a>
                <br />
                <br />
                <a href={'https://compute.toys/view/1361'} target="_blank" rel="noopener noreferrer">
                    Simple rasterizer
                </a>
                <br />
                <br />
            ...
            and outputs for this shader, as well as a few helper functions and type definitions. Please refer to the
